...
from utils.messages import welcome_msg, new_user_alert, support_menu_msg
from keyboards.reply import main_menu
from keyboards.inline import support_menu_keyboard
...
async def our_channels(message: Message):
    ...
    await message.answer(
        ...
        + "\n".join(lines) +
        "\n\n━━━━━━━━━━━━━━━━━━━━\n"
        "<i>Join to stay updated with latest deals!</i>",
        parse_mode="HTML",
